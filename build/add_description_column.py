...
BW={
 ...
 18:"The first column of the site table. One row per owning department, office or RM, so they can be compared side by side.",
 19:"For the one department, office or RM on that row: how many EDRMS sites it owns.",
 20:"For the one department, office or RM on that row: every document held across that row's EDRMS sites.",
 21:"For the one department, office or RM on that row: how many of its documents have been declared as records.",
 22:"For the one department, office or RM on that row: how many of its declared records also exist on paper.",
 ...
 74:"A comparison showing, for each department, office or RM, how many documents it holds against how many it has declared.",
...
DI={
 7:"Not a figure. The control that chooses which department, office or RM the whole screen is about. Every figure below is for that one choice only, called 'the selected department' throughout this column.",
 8:"How many EDRMS sites the selected department owns.",
 9:"How many people count as EDRMS users for the selected department.",
 10:"How many people visited the selected department's EDRMS sites.",
 11:"Every document held across the selected department's EDRMS sites, declared or not.",
 12:"How many of the selected department's documents have been declared as records.",
 13:"How many of the selected department's declared records also exist on paper.",
 14:"How many of the selected department's records reach their disposal due date.",
 15:"Not a figure. Each tile opens a table underneath showing the detail behind it.",
 16:"The naming rules the selected department's sites, libraries and folders are meant to follow.",
 17:"The date the selected department started using EDRMS.",
 19:"How many of the selected department's people have used EDRMS recently.",
 20:"How many of the selected department's people opened EDRMS in the last 180 days.",
 21:"How many had access but did not open EDRMS in the last 180 days.",
 22:"How many of the selected department's people have access to an EDRMS site but have never once opened it.",
 23:"Of the selected department's EDRMS users, how many are ADB staff.",
 24:"Of the selected department's EDRMS users, how many are contractors.",
 25:"Of the selected department's EDRMS users, how many are consultants.",
 26:"What share of the selected department's EDRMS users have completed EDRMS training.",
 28:"How many EDRMS sites the selected department owns, shown above its site table.",
 29:"Every document across the selected department's sites, shown above its site table.",
 30:"Records declared across the selected department's sites.",
 31:"Paper counterparts across the selected department's sites.",
 32:"Records in the selected department falling due for disposal within the next 12 months.",
 33:"One row per site. The name of each EDRMS site the selected department owns.",
 ...
 40:"How many people visited the selected department's EDRMS sites.",
 41:"A table showing visit activity for each of the selected department's sites.",
 42:"How many pages were viewed in total across the selected department's sites.",
 ...
 50:"Of the people who visited the selected department's sites, how many came from outside ADB.",
 51:"Of the people who visited the selected department's sites, how many came from inside ADB.",
 52:"How many requests to join the selected department's sites were approved.",
 53:"How many requests to join the selected department's sites were refused.",
 55:"How many documents have been put into the selected department's sites.",
 56:"How many of the selected department's EDRMS sites are currently active.",
 57:"How much storage space the selected department's documents occupy.",
 ...
 61:"How many distinct people created documents in the selected department's sites.",
 63:"Records declared across the selected department's sites.",
 64:"How many distinct people in the selected department declared at least one record.",
 65:"Which of the selected department's sites have had no record declared in the last 180 days.",
 ...
 68:"How much storage space the selected department's declared records occupy.",
 ...
 72:"How many of the selected department's declared records also exist on paper.",
 73:"The selected department's total declared records, shown alongside for comparison.",
 ...
 78:"Of the selected department's paper counterparts, how many have been handed over to RAC.",
 80:"Records in the selected department falling due for disposal within the next 3 months.",
 81:"Records in the selected department falling due for disposal within the next 6 months.",
 82:"Records in the selected department falling due for disposal within the next 12 months.",
 ...
 86:"Who approved each disposal in the selected department.",
 87:"How many disposal requests in the selected department were approved.",
 88:"How many disposal requests in the selected department were declined.",
 89:"How many had their retention extended instead of being disposed.",
 90:"How many of the selected department's records were actually disposed, by month and year.",
 91:"How much storage space the disposed records had occupied.",
 93:"One row per library. The name of each library inside the selected department's sites.",
 ...
 101:"The key dates in the EDRMS rollout programme for the selected department.",
}
